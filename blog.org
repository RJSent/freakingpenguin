...
- Linux [[https://www.gnu.org/gnu/incorrect-quotation.en.html][(I'd just like to interject for a moment...)]]

- Emacs / Emacs Lisp

- Nginx (This website is hosted on a virtual private server using Nginx!)
...
object-oriented standpoint, and I feel many of the core principles
apply to procedural languages like C. (Maybe I'll write a post on this
